...
if (isset($_POST['submitotp'])) {
    $otp = $_POST['OTP'];
    $mainOTP = $session->get("otp");

    if ($otp == $mainOTP) {
        echo '<script> window.location.href = "forgot-password-3.php"; </script>';
        exit();
    } else {
                        ...
                        <div class="signup-form-wrapper">
                            ...
                            <form id="loginForm" action="" method="POST">
                                <div class="input-wrapper mb-4">
                                    <input type="number" id="otp" placeholder="OTP" name="OTP" required>
                                </div>
                                <div class="submit-btn-wrapper">
                                    <button class="signup-btn btn-1" type="submit" name="submitotp">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
