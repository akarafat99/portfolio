                ...
                if (!empty($allDetails)) {
                  ...
                  foreach ($allDetails as $detail) {
                    ...
                    if ($isUserLoggedIn) {
                      ...
                      echo "<td>You need to have a valid account to access resources. Please login.</td>";
                    }
                  ...
                  echo "<tr><td colspan='4'>No course contents available.</td></tr>";
                }
                ?>
              </tbody>
            </table>
