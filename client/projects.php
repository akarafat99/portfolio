                        ...
                        <div class="col-md-12 mb-4 project-card" data-type="<?php echo $project->project_type; ?>" data-title="<?php echo htmlspecialchars(strtolower($project->title)); ?>" data-desc="<?php echo htmlspecialchars(strtolower($project->description)); ?>">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Show description at most 30 characters -->
                                    <p style="text-align:justify;" class="card-text"><strong>Description:</strong> <?php echo substr($project->description, 0, 300); ?>...</p>
                                    <!-- a button to view this all details -->
                                    <a href="project-details.php?project_id=<?php echo $project->project_id; ?>" class="btn btn-primary">View Details</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
