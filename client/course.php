...
$course = new Course();
$allCourses = $course->getAllCourse(); // Assuming this fetches all the courses from the database
?>
        ...
        <div class="section-heading-wrapper mb-4">
          ...
          <div class="filter-search-wrap">
            <div class="filter-button-wrap" id="courseFilter">
              ...
              <button class="filter-btn" value="bsc">B.Sc</button>
              <button class="filter-btn" value="msc">M.Sc</button>
              <button class="filter-btn" value="training">Training</button>
            </div>
              ...
              <div class="col-md-6 mb-4" data-category="<?= htmlspecialchars($course['program_name']) ?>">
                <div class="course-card-wrapper">
                  <div class="course-card">
                    ...
                    <p class="course-text mb-1"><strong>Course Code:</strong> <?= htmlspecialchars($course['course_code']) ?></p>
                    <p class="course-text mb-1"><strong>Description:</strong> <?= htmlspecialchars($course['course_details']) ?></p>
                    <p class="course-text mb-1"><strong>Program:</strong>
                      <?php
                      // Check the program type and display accordingly
                      switch (strtolower($course['program_name'])) {
                        case 'bsc':
                          echo "B. Sc.";
                          break;
                        case 'msc':
                        ...
                        case 'training':
                          ...
                          break;
                        default:
                          echo htmlspecialchars($course['program_name']); // In case of other values
                      }
                      ?>
                    </p>
