...
if (isset($_GET['lab_id'])) {
    $researchLab->lab_id = $_GET['lab_id'];
    $researchLab->getResearchLabById();
}
    ...
    <div class="site-wrap">
        ...
        <section class="lab-content-section">
            <div class="container">
                <div class="row ">
                    <div class="col-lg-8 ">
                        <div class="lab-details-content-wrap">
                            <h1 class="lab-details-heading"><?= htmlspecialchars($researchLab->lab_title); ?></h1>
                            <div class="horizontal-line"></div>
                            <div class="lab-about-description">
                                <p><?= nl2br(htmlspecialchars($researchLab->lab_about)); ?></p>
                            </div>
                            <div class="lab-outcomes-description">
                                <h3>Lab Outcomes</h3>
                                <p><?= nl2br(htmlspecialchars($researchLab->lab_outcomes)); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 lab-right-content-wrap">
                        <div class="lab-head-members-wrap">
                            <div class="lab-head-content-wrap">
                                <div class="lab-headin-wrap">
                                    <h3>Lab Head</h3>
                                </div>
                                <div class="horizontal-line"></div>
                                <div class="lab-head-name-img-wrap">
                                    <div class="lab-head-info">
                                        <h4><?= htmlspecialchars($researchLab->lab_head_name); ?></h4>
                                    </div>
                                </div>
                                <div class="lab-head-about-text">
                                    <h4>About</h4>
                                    <p><?= htmlspecialchars($researchLab->lab_head_details); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="lab-head-members-wrap">
                            <div class="lab-head-content-wrap">
                                ...
                                <div class="horizontal-line"></div>
                                <div class="lab-team-member-lists">
                                    <?php
                                    // Explode names and details into arrays
                                    $labMembersNames = explode('#', $researchLab->lab_members_name);
                                    $labMembersDetails = explode('#', $researchLab->lab_members_details);

                                    // Ensure both arrays have the same length
                                    $totalMembers = min(count($labMembersNames), count($labMembersDetails));

                                    // Loop through each member and display their information
                                    for ($i = 0; $i < $totalMembers; $i++) {
                                        $name = htmlspecialchars($labMembersNames[$i], ENT_QUOTES, 'UTF-8');
                                        $details = nl2br(htmlspecialchars($labMembersDetails[$i], ENT_QUOTES, 'UTF-8'));
                                        echo "<div class='lab-team-member-item-wrap'>
                                                <div class='lab-team-member-item'>
                                                    <div class='lab-team-member-info-wrap'>
                                                        <h5>$name</h5>
                                                        <p>$details</p>
                                                    </div>
                                                </div>
