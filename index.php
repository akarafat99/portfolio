...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  include_once __DIR__ . "/client/navbar.php";
  ?>
      ...
      <div class="timeline">
        ...
        <div class="timeline-item">
          ...
          <div class="timeline-item-content">
            <h4>API Developer <small>Shopify</small></h4>
            <p>Promote your blog posts, case studies, and product announcements with branded videos.</p>
            <small>2021</small>
          </div>
        </div>
        <!-- Timeline Item -->
        <div class="timeline-item left">
          ...
          <div class="timeline-item-content">
            <h4>Master's Degree <small>Oxford University</small></h4>
            <p>Promote your blog posts, case studies, and product announcements with branded videos.</p>
            <small>2018</small>
          </div>
        </div>
        ...
        <div class="timeline-item">
          ...
          <div class="timeline-item-content">
            <h4>Web Developer <small>Envato</small></h4>
            <p>Promote your blog posts, case studies, and product announcements with branded videos.</p>
            <small>2017</small>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 mb-4 mb-lg-0">
          <img src="https://via.placeholder.com/500x300" alt="Research Image" class="img-fluid rounded shadow-sm">
        </div>
  ...
  <section class="section-courses py-5">
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <!-- Right Column -->
        <div class="col-lg-6">
          <img src="https://via.placeholder.com/500x300" alt="Courses Image" class="img-fluid rounded shadow-sm">
        </div>
      </div>
    </div>
  </section>
